          ...
          <nav class="navbar navbar-inverse navbar-fixed-top" role="navigation">
               <div class="container">
					...
					<button type="submit" class="btn-info" >Search<span class="glyphicon-search"></span>
						...
						<li><a href="index.php#about"><span class="btnicon icon-user"></span>C-history</a></li>
                        <li><a href="index.php#services"><span class="btnicon icon-cup"></span>About US: </a></li>
                        <li><a href="index.php#portfolio"><span class="btnicon icon-rocket"></span></a></li>
...
<?php
				...
				while($row = $result->fetch_assoc())
				{
				   ...
				   if ($check==1)
				   {
					...
					echo "<br>
						...
						<center>
						<button style='width:150px; height:150px;  background: linear-gradient(to bottom right, yellow , brown);font-size:100px; border-radius:600px;'>
						<h3>".$row['title']."</h3>
	...
	<input type='submit' class='btn btn-danger' value='Dislike' />
						...
						<div style='background-color: #CCCC99 ; color:#000099;width:auto; height:1000px'><center>
...
else 
	{
			...
			if (mysqli_num_rows($result) > 0) 
			{
                ...
                <center><form action='".$_SERVER['PHP_SELF']."' method='get'>
					...
					<br><button style='width:150px; height:150px;  background: linear-gradient(to bottom right, yellow , brown);font-size:100px; border-radius:600px;'>
									<b>".$i."</b></button>
				</form>
				<h3>".$row['title']."</h3>
				<h5><b>By-".$row['name']."</b></h5>
